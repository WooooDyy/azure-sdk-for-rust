...
use crate::file::file_share::responses::GetFileShareACLResponse;

#[derive(Debug, Clone)]
pub struct GetFileShareACLBuilder<'a>{
...
impl<'a> GetFileShareACLBuilder<'a>{
    ...
    pub async fn execute(self) -> Result<GetFileShareACLResponse, Box<dyn std::error::Error + Sync + Send>> {
