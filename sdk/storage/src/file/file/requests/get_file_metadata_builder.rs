...
use crate::file::file::responses::get_file_metadata_response::GetFileMetadataResponse;

#[derive(Debug,Clone)]
pub struct GetFileMetadataBuilder<'a> {
...
impl<'a> GetFileMetadataBuilder<'a>{
    ...
    pub async fn execute(
        &self,
    )->Result<GetFileMetadataResponse, Box<dyn std::error::Error + Send + Sync>>{
        ...
        let result = (response.body(), response.headers()).try_into()?;
        Ok(result)
