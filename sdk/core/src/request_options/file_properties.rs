...
// pub struct FileProperties<'a, 'b>(HashMap<Cow<'a, str>, Cow<'b, str>>);
//
// const HEADER: &str = "x-ms-properties";
//
// impl<'a, 'b> Default for FileProperties<'a, 'b> {
//     fn default() -> Self {
//         Self::new()
//     }
// }
//
// impl<'a, 'b> FileProperties<'a, 'b> {
//     pub fn new() -> Self {
//         Self(HashMap::new())
//     }
//
...
// }
//
// impl<'a, 'b> AddAsHeader for FileProperties<'a, 'b> {
//     fn add_as_header(&self, mut builder: Builder) -> Builder {
...
//            builder = builder.header(&format!("{}={},", k.as_ref(), v.as_ref()), builder);
//         });
//
...
// }
//
// impl TryFrom<&HeaderMap> for FileProperties<'static, 'static> {
...
//             .into_iter()
//             .map(|(key, value)| {
//                 let value = std::str::from_utf8(&value?)?.to_owned(); // the value is base64 encoded se we decode it
//                 Ok((key, value))
//             })
